          ...
          <Jumbotron fluid>
            <Container fluid>
              <Row>
                ...
                <Col>
                  <Fade left delay={400}>
                    <i className="fas fa-hand-holding-heart fa-5x"></i><br/><h2>Gutes Gewissen!<br/> </h2> <h3>Schonend zur Natur und regional hergestellt.</h3>
                  </Fade>
                </Col>
                <Col>
                  <Fade left delay={400}>
                    <i className="fas fa-percent fa-5x"></i><br/><h2>100% investiert!<br/> </h2> <h3> Nichts in die eigene Hosentasche. </h3>
                  </Fade>
                </Col>
              </Row>
            </Container>
